...
export const CreatePopUp = ({ show, onClose, create }) => {
    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center justify-center md:justify-start p-4 rounded w-[300px] md:w-[500px] h-[200px] bg-selected text-title relative z-20 translate-y-50 -top-[50%] left-[20%] right-[20%] '>
